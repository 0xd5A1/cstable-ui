...
export class BootService {
	...
	constructor() {
		...
		this.pool1Contract = new ethers.Contract(environment.pool1.address, CStablePool.abi, this.provider);
		...
		this.bstTokenContract = new ethers.Contract(environment.bstToken.address, CSTToken.abi, this.provider);
